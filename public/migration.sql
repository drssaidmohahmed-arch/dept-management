...
INSERT INTO teaching_assignments (id, professor_id, professor_name, course_code, course_name, section, room_id, room_name, day, start_time, end_time, session_type, academic_year, semester, created_at) VALUES
  ('88880004-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000010', 'د. أحمد محمد الشريف', 'CS101', 'مقدمة في علوم الحاسب', 1, '88880003-0000-0000-0000-000000000001', 'قاعة المحاضرات الكبرى', 'saturday', '08:00', '09:50', 'lecture', '1446هـ', 1, '2025-01-15T00:00:00.000Z'),
  ('88880004-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000010', 'د. أحمد محمد الشريف', 'CS102', 'مبادئ البرمجة', 1, '88880003-0000-0000-0000-000000000003', 'معمل البرمجة ١', 'sunday', '10:00', '11:50', 'lab', '1446هـ', 1, '2025-01-15T00:00:00.000Z'),
  ('88880004-0000-0000-0000-000000000003', '00000000-0000-0000-0000-000000000011', 'د. فاطمة علي الحسن', 'MATH101', 'رياضيات متقدمة', 1, '88880003-0000-0000-0000-000000000002', 'قاعة المحاضرات ٢', 'monday', '08:00', '09:50', 'lecture', '1446هـ', 1, '2025-01-15T00:00:00.000Z'),
  ('88880004-0000-0000-0000-000000000004', '00000000-0000-0000-0000-000000000010', 'د. أحمد محمد الشريف', 'CS201', 'هياكل البيانات', 1, '88880003-0000-0000-0000-000000000004', 'معمل البرمجة ٢', 'tuesday', '10:00', '11:50', 'lab', '1446هـ', 1, '2025-01-15T00:00:00.000Z'),
  ('88880004-0000-0000-0000-000000000005', '00000000-0000-0000-0000-000000000011', 'د. فاطمة علي الحسن', 'CS202', 'قواعد البيانات', 1, '88880003-0000-0000-0000-000000000003', 'معمل البرمجة ١', 'wednesday', '08:00', '09:50', 'lab', '1446هـ', 1, '2025-01-15T00:00:00.000Z'),
  ('88880004-0000-0000-0000-000000000006', '00000000-0000-0000-0000-000000000012', 'د. خالد عبدالله العمري', 'CS205', 'شبكات الحاسب ١', 1, '88880003-0000-0000-0000-000000000005', 'معمل الشبكات', 'thursday', '10:00', '11:50', 'lab', '1446هـ', 1, '2025-01-15T00:00:00.000Z'),
  ('88880004-0000-0000-0000-000000000007', '00000000-0000-0000-0000-000000000010', 'د. أحمد محمد الشريف', 'CS301', 'تحليل الخوارزميات', 1, '88880003-0000-0000-0000-000000000001', 'قاعة المحاضرات الكبرى', 'sunday', '08:00', '09:50', 'lecture', '1446هـ', 1, '2025-01-15T00:00:00.000Z'),
  ('88880004-0000-0000-0000-000000000008', '00000000-0000-0000-0000-000000000011', 'د. فاطمة علي الحسن', 'CS305', 'ذكاء اصطناعي', 1, '88880003-0000-0000-0000-000000000008', 'قاعة التعليم عن بعد', 'tuesday', '08:00', '09:50', 'lecture', '1446هـ', 1, '2025-01-15T00:00:00.000Z');
...
INSERT INTO performance_evaluations (id, faculty_id, faculty_name, evaluation_type, academic_year, semester, teaching_score, research_score, service_score, overall_score, comments, created_at) VALUES
  ('88880005-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000010', 'د. أحمد محمد الشريف', 'student_feedback', '1445هـ', 2, 4.50, 4.20, 4.00, 4.23, 'أداء ممتاز في التدريس وحضور نشط في المؤتمرات العلمية', '2024-06-15T00:00:00.000Z'),
  ('88880005-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000011', 'د. فاطمة علي الحسن', 'student_feedback', '1445هـ', 2, 4.70, 3.90, 4.30, 4.30, 'أستاذة متميزة في التواصل مع الطلاب وتقديم المحتوى بطريقة مبسطة', '2024-06-15T00:00:00.000Z'),
  ('88880005-0000-0000-0000-000000000003', '00000000-0000-0000-0000-000000000012', 'د. خالد عبدالله العمري', 'student_feedback', '1445هـ', 2, 4.00, 3.50, 3.80, 3.77, 'أداء جيد مع مجال للتحسين في النشاط البحثي', '2024-06-15T00:00:00.000Z'),
  ('88880005-0000-0000-0000-000000000004', '00000000-0000-0000-0000-000000000010', 'د. أحمد محمد الشريف', 'chairman_review', '1445هـ', 2, 4.60, 4.40, 4.10, 4.37, 'إسهامات ملموسة في تطوير المناهج وتحديث المقررات', '2024-06-20T00:00:00.000Z'),
  ('88880005-0000-0000-0000-000000000005', '00000000-0000-0000-0000-000000000011', 'د. فاطمة علي الحسن', 'peer_review', '1445هـ', 2, 4.50, 4.10, 4.20, 4.27, 'زملاء يعترفون بجودة بحثها وتعاونها المستمر', '2024-06-18T00:00:00.000Z'),
  ('88880005-0000-0000-0000-000000000006', '00000000-0000-0000-0000-000000000016', 'د. محمد فيصل الغامدي', 'self_assessment', '1445هـ', 2, 4.30, 4.80, 3.90, 4.33, 'أستاذ متميز أكاديمياً مع إسهامات بحثية كبيرة', '2024-06-10T00:00:00.000Z');
...
INSERT INTO professional_development (id, faculty_id, faculty_name, title, activity_type, provider, location, start_date, end_date, hours, status, created_at) VALUES
  ('88880006-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000010', 'د. أحمد محمد الشريف', 'المؤتمر الدولي للذكاء الاصطناعي', 'conference', 'IEEE', 'الرياض', '2025-03-15', '2025-03-18', 24, 'planned', '2025-01-10T00:00:00.000Z'),
  ('88880006-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000011', 'د. فاطمة علي الحسن', 'ورشة العمل المتقدمة في PostgreSQL', 'workshop', 'أوراكل', 'جدة', '2024-11-10', '2024-11-11', 16, 'completed', '2024-10-20T00:00:00.000Z'),
  ('88880006-0000-0000-0000-000000000003', '00000000-0000-0000-0000-000000000012', 'د. خالد عبدالله العمري', 'شهادة أمن المعلومات CISSP', 'certification', 'ISC2', 'عن بُعد', '2025-01-01', '2025-03-01', 120, 'planned', '2024-12-01T00:00:00.000Z'),
  ('88880006-0000-0000-0000-000000000004', '00000000-0000-0000-0000-000000000010', 'د. أحمد محمد الشريف', 'ندوة التعلم الآلي في التطبيقات الطبية', 'seminar', 'جامعة الملك سعود', 'الرياض', '2024-10-20', '2024-10-20', 4, 'completed', '2024-09-15T00:00:00.000Z'),
  ('88880006-0000-0000-0000-000000000005', '00000000-0000-0000-0000-000000000016', 'د. محمد فيصل الغامدي', 'دورة المعالجة اللغوية العربية', 'training_course', 'كليokit', 'الرياض', '2024-08-01', '2024-08-15', 40, 'completed', '2024-07-15T00:00:00.000Z'),
  ('88880006-0000-0000-0000-000000000006', '00000000-0000-0000-0000-000000000011', 'د. فاطمة علي الحسن', 'المؤتمر العربي لعلوم البيانات', 'conference', 'جمعية الحاسب العربي', 'دبي', '2025-02-10', '2025-02-12', 20, 'planned', '2024-12-20T00:00:00.000Z');
...
INSERT INTO advising_sessions (id, student_id, student_name, advisor_id, advisor_name, session_date, session_type, notes, action_items, follow_up_date, created_at) VALUES
  ('88880007-0000-0000-0000-000000000001', 'ST-2024-001', 'عبدالرحمن محمد السالم', '00000000-0000-0000-0000-000000000010', 'د. أحمد محمد الشريف', '2025-01-12T09:00:00.000Z', 'academic_plan', 'مناقشة الخطة الدراسية للفصل القادم وتحديد المقررات المناسبة', ARRAY['تسجيل CS301', 'تسجيل CS305', 'مراجعة شروط التخرج'], '2025-02-01', '2025-01-12T09:00:00.000Z'),
  ('88880007-0000-0000-0000-000000000002', 'ST-2024-006', 'لمى أحمد الزهراني', '00000000-0000-0000-0000-000000000010', 'د. أحمد محمد الشريف', '2025-01-10T10:00:00.000Z', 'academic_warning', 'تنبيه الطالبة بانخفاض المعدل التراكمي ووضع خطة علاجية لتحسين الأداء', ARRAY['حضور ورطة المهارات الأكاديمية', 'متابعة أسبوعية مع المرشد', 'تقليل عدد الساعات المسجلة'], '2025-01-24', '2025-01-10T10:00:00.000Z'),
  ('88880007-0000-0000-0000-000000000003', 'ST-2024-004', 'ريم خالد الشمري', '00000000-0000-0000-0000-000000000011', 'د. فاطمة علي الحسن', '2025-01-08T11:00:00.000Z', 'course_guidance', 'إرشاد الطالبة حول اختيار المقررات الاختيارية المناسبة لتخصصها', ARRAY['اختيار مقرر الذكاء الاصطناعي', 'استكمال متطلب اللغة الإنجليزية'], '2025-02-08', '2025-01-08T11:00:00.000Z'),
  ('88880007-0000-0000-0000-000000000004', 'ST-2024-009', 'بدر همام السبيعي', '00000000-0000-0000-0000-000000000010', 'د. أحمد محمد الشريف', '2025-01-06T14:00:00.000Z', 'academic_warning', 'نقاش تفصيلي مع الطالب حول صعوباته الأكاديمية ووضع خطة لرفع المعدل', ARRAY['تكرار مقرر رياضيات متقدمة', 'التسجيل في حصص تقوية', 'اجتماع مع الأهل'], '2025-01-20', '2025-01-06T14:00:00.000Z'),
  ('88880007-0000-0000-0000-000000000005', 'ST-2024-005', 'سلطان فيصل المطيري', '00000000-0000-0000-0000-000000000012', 'د. خالد عبدالله العمري', '2025-01-14T10:00:00.000Z', 'career_advice', 'مناقشة فرص التدريب والعمل بعد التخرج ومتطلبات سوق العمل', ARRAY['التقديم على برنامج التدريب التعاوني', 'بناء معرض الأعمال', 'حضور فعاليات التوظيف'], '2025-03-01', '2025-01-14T10:00:00.000Z'),
  ('88880007-0000-0000-0000-000000000006', 'ST-2024-003', 'فهد سعد العتيبي', '00000000-0000-0000-0000-000000000010', 'د. أحمد محمد الشريف', '2025-01-15T08:00:00.000Z', 'general', 'استفسار حول عملية التسجيل ومواعيد إسقاط المقررات', ARRAY['مراجعة دليل الطالب', 'التواصل مع مكتب القبول'], '2025-01-22', '2025-01-15T08:00:00.000Z'),
  ('88880007-0000-0000-0000-000000000007', 'ST-2024-007', 'ماجد ناصر الدوسري', '00000000-0000-0000-0000-000000000012', 'د. خالد عبدالله العمري', '2025-01-05T12:00:00.000Z', 'academic_plan', 'مراجعة الخطة الدراسية وتحديد المقررات المتبقية للتخرج', ARRAY['تسجيل مقرر الشبكات', 'التحقق من إكمال المتطلبات'], '2025-01-19', '2025-01-05T12:00:00.000Z'),
  ('88880007-0000-0000-0000-000000000008', 'ST-2024-010', 'أسماء طارق البقمي', '00000000-0000-0000-0000-000000000011', 'د. فاطمة علي الحسن', '2025-01-11T09:30:00.000Z', 'course_guidance', 'مناقشة اختيار مسار التخصص الدقيق بين البرمجيات والشبكات', ARRAY['زيارة مكتب التوجيه', 'مقابلة مع أستاذ الشبكات'], '2025-02-11', '2025-01-11T09:30:00.000Z');
...
INSERT INTO graduation_projects (id, student_id, student_name, title, description, supervisor_id, supervisor_name, project_type, status, grade, submission_date, defense_date, created_at) VALUES
  ('88880009-0000-0000-0000-000000000001', 'ST-2024-001', 'عبدالرحمن محمد السالم', 'نظام ذكي لإدارة الجداول الزمنية باستخدام الخوارزميات الجينية', 'تطبيق نظام ذكي لتوليد الجداول الزمنية للمؤسسات التعليمية باستخدام الخوارزميات الجينية مع واجهة ويب تفاعلية.', '00000000-0000-0000-0000-000000000010', 'د. أحمد محمد الشريف', 'software', 'in_progress', NULL, NULL, NULL, '2025-01-10T00:00:00.000Z'),
  ('88880009-0000-0000-0000-000000000002', 'ST-2024-004', 'ريم خالد الشمري', 'تحليل المشاعر في التغريدات العربية باستخدام التعلم العميق', 'مشروع بحثي لتحليل المشاعر في النصوص العربية على منصة تويتر باستخدام نماذج التعلم العميق والتعامل مع التحديات اللغوية للعربية.', '00000000-0000-0000-0000-000000000011', 'د. فاطمة علي الحسن', 'research', 'approved', NULL, NULL, NULL, '2025-01-08T00:00:00.000Z'),
  ('88880009-0000-0000-0000-000000000003', 'ST-2024-002', 'نورة عبدالله الحربي', 'نظام إدارة ملفات تعريف الارتباط المتوافق مع سياسات الخصوصية', 'تطوير نظام آمن لإدارة ملفات تعريف الارتباط يتوافق مع سياسات الخصوصية العامة GDPR ويسمح للمستخدمين بالتحكم الكامل ببياناتهم.', '00000000-0000-0000-0000-000000000011', 'د. فاطمة علي الحسن', 'system', 'proposed', NULL, NULL, NULL, '2025-01-15T00:00:00.000Z'),
  ('88880009-0000-0000-0000-000000000004', 'ST-2024-005', 'سلطان فيصل المطيري', 'نظام مراقبة الشبكات باستخدام تقنيات إنترنت الأشياء', 'تصميم وتنفيذ نظام متكامل لمراقبة حالة أجهزة الشبكة باستخدام مستشعرات إنترنت الأشياء مع لوحة تحكم مركزية.', '00000000-0000-0000-0000-000000000012', 'د. خالد عبدالله العمري', 'software', 'approved', NULL, NULL, NULL, '2025-01-12T00:00:00.000Z'),
  ('88880009-0000-0000-0000-000000000005', 'ST-2024-003', 'فهد سعد العتيبي', 'دراسة مقارنة لتقنيات التخزين المؤقت في قواعد البيانات', 'بحث نظري يقارن بين تقنيات التخزين المؤقت المختلفة مثل Redis وMemcached وتأثيرها على أداء تطبيقات الويب.', '00000000-0000-0000-0000-000000000010', 'د. أحمد محمد الشريف', 'theoretical', 'proposed', NULL, NULL, NULL, '2025-01-14T00:00:00.000Z');
